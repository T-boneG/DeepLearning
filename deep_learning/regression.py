...
class LogisticRegression(object):
    ...
    def predict(self, X):
        ...
        A = LogisticRegression.forward_propagate(X, self.params['w'], self.params['b'])
    ...
    def _propagate(self, X, Y):
        ...
        A = LogisticRegression.forward_propagate(X, self.params['w'], self.params['b'])
        cost = LogisticRegression.compute_cost(Y, A)

        # BACKWARD PROPAGATION (TO FIND GRAD)
        dw, db = LogisticRegression.backward_propagate(X, Y, A)
